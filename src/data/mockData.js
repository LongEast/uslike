  ...
  return [
    {
      ...
      time: "今天 20:18",
      likes: [
        { id: "feed-1-like-xiaoju", user: "小橘", isFriend: false },
      ],
      comments: [
        {
          id: "feed-1-comment-linyu",
          user: "林屿",
          avatar: "https://api.dicebear.com/9.x/thumbs/svg?seed=feed-comment-linyu",
          text: "这条路线听起来很舒服，想收藏起来下次也走走。",
          isFriend: false,
        },
        {
          id: "feed-1-comment-wanwan",
          user: "弯弯",
          avatar: "https://api.dicebear.com/9.x/thumbs/svg?seed=feed-comment-wanwan",
          text: "橘色路灯那一段一定很有电影感。",
          isFriend: false,
        },
      ],
    ...
    },
    {
      ...
      time: "今天 19:42",
      likes: [{ id: "feed-2-like-chuanchuan", user: "川川", isFriend: false }],
      comments: [],
      tags: ["音乐", "睡前", "慢节奏"],
      viewerAvatar: "https://api.dicebear.com/9.x/thumbs/svg?seed=orange",
    },
    {
      ...
      time: "今天 17:06",
      likes: [
        { id: "feed-3-like-ache", user: "阿澈", isFriend: false },
      ],
      comments: [
        {
          id: "feed-3-comment-muli",
          user: "木栗",
          avatar: "https://api.dicebear.com/9.x/thumbs/svg?seed=feed-comment-muli",
          text: "只负责找边框听起来很适合我，可以报名吗？",
          isFriend: false,
        },
      ],
      tags: ["拼图", "周末", "轻游戏"],
    ...
    },
    {
      ...
      time: "昨天 22:31",
      likes: [{ id: "feed-4-like-tangli", user: "唐梨", isFriend: false }],
      comments: [],
      tags: ["电影", "片尾曲", "旧时光"],
      viewerAvatar: "https://api.dicebear.com/9.x/thumbs/svg?seed=orange",
    },
